...
- (void)dealloc
{
    LogWarn(@"dealloc %@", NSStringFromClass([self class]));
...
- (void)readDataToLength:(NSUInteger)length completionHandler:(void (^)(NSData *data))handler{
...
- (void)readDataToData:(NSData *)data completionHandler:(void (^)(NSData *data))handler {
    GCDAsyncReadPacket *packet = [[GCDAsyncReadPacket alloc] initWithData:nil
                                                              startOffset:0
                                                                maxLength:0
                                                                  timeout:-1
